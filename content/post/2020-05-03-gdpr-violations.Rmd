...
ggplot(gdpr_country_price, aes(x = name, 
  ...
  geom_col() +
  labs(
    title = "Total Cost of GDPR Violations 2018-2020 by Country (Top5)",
    x = "Country Name",
    fill = "Country Name",
